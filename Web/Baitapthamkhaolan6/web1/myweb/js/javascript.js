...
{
	userArray = JSON.parse(localStorage.getItem('user'));
	var user1 = {username: 'user123', password: '123456', fullname: 'Nguyen Van C ' , datesignup: '23-11-1999'};
	console.log(user1);
...
function theloaimenu()
{
    var theloaiarr=[
		...
		{	
				var a='<a href="DemoCSS.html?'+theloaiarr[i].matl+'&1"><li onclik="hienthi1(this);">'+ theloaiarr[i].tentl + '</li></a>';		
					s+=a;
